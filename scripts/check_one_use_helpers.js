...
const acceptedOneUseHelpers = new Map([
  ...
  [
    ...
    new Set([
      ...
      "unrealized_interest",
      "quote_integrated_concentrated_exact_in_nad",
  ...
  [
    "programs/dusk/src/math/amm/concentrated.rs",
    new Set([
      "parameters",
      "center_point",
      "center_point_with_geometry",
      "price_bounds_nad",
      "prepare_centered_concentrated_geometry",
      "prepare_centered_concentrated_cache",
